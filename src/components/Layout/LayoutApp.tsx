// Layoutapp, retornado com {children} faz o complemento da página toda com outras opções de navegação como (home, links e configurações)
...
export default function LayoutApp({children}: { children: React.ReactNode })
    {
        return (
            <html lang="en">
            <body className="relative h-screen overflow-hidden bg-gray-100 dark:bg-gray-800">
              ...
              <span className="text-left">
                ...
                <span className="w-4 h-2 p-1 ml-4 text-xs text-gray-400 bg-gray-200 rounded-lg">
                  0
                                ...
                                <LinkMenu href={'/app/id-tenant/links'}>
              <span className="text-left">
                <svg
                    fill="currentColor"
                    height="20"
                ...
                Links
                                ...
                                <LinkMenu href={'/app/id-tenant/settings'}>
              <span className="text-left">
                <svg
                    fill="currentColor"
                    height="20"
